...
window.onload = function () {
  ...
  document
    .getElementById("top-10-list")
    .addEventListener("click", listGoToMinute);
  document
    .getElementById("players-list")
    .addEventListener("click", playersGoToMinute);
  ...
  textTrack.oncuechange = function () {
    ...
    if (cue != null) {
      ...
      document.getElementById("player-pic").src =
        "./resources/" + obj.player.pic;
      document.getElementById("player-dob").innerHTML = convertDigitIn(
        obj.player.dob
      );
      ...
      document.getElementById("player-shirt-number").innerHTML =
        obj.player.number;
      ...
      document.getElementById("player-rebounds").innerHTML =
        obj.player.rebounds;
      ...
      if (pTeam.localeCompare(sTeam)) {
        document.getElementById("img-player-team").src =
          "./resources/" + obj.scoreboard.visitor_pic;
      } else {
        document.getElementById("img-player-team").src =
          "./resources/" + obj.scoreboard.home_pic;
      }

      // Update teams data
      document.getElementById("img-home-team").src =
        "./resources/" + obj.scoreboard.home_pic;
      document.getElementById("img-visitor-team").src =
        "./resources/" + obj.scoreboard.visitor_pic;
      document.getElementById("home-points").innerHTML =
        obj.scoreboard.home_points;
      document.getElementById("visitor-points").innerHTML =
        obj.scoreboard.visitor_points;
      document.getElementById("home-team-name").innerHTML =
        obj.scoreboard.home_team;
      document.getElementById("visitor-team-name").innerHTML =
        obj.scoreboard.visitor_team;
      document.getElementById("match-date").innerHTML = convertDigitIn(
        obj.scoreboard.date
      );
      ...
      document.getElementById("players-list").scrollTop =
        (play_number - 1) * 217.5;

      //Actualizar lista de jugadas
      document
        .getElementById("btn-play-" + active_play)
        .classList.remove("active");
      document
        .getElementById("btn-play-" + play_number)
